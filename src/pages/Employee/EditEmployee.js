			...
			<div className='w-full max-w-sm container mt-20 mx-auto'>
				<form onSubmit={onSubmit}>
					...
					<div className='flex items-center justify-between'>
						<button className='block mt-5 bg-green-400 w-full hover:bg-green-500 text-white font-bold py-2 px-4 rounded focus:text-gray-600 focus:shadow-outline'>Edit Employee</button>
					</div>
