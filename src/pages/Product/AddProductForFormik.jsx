				...
				<form onSubmit={formik.handleSubmit}>
					<div className='product__form-item'>
						<input
							...
							className={`product__form-control ${formik.errors.productName ? 'is-invalid' : ''}`}
						/>
					...
					<div className='product__form-item'>
						<input
							...
							className={`product__form-control ${formik.errors.price ? 'is-invalid' : ''}`}
						/>
						<div className='product__form-text--error'>
					...
					<div className='product__form-item flex-row'>
						<label htmlFor='radio-1' className='product__form-radio '>
							<input
								...
								type='radio'
								value='1'
								checked={formik.values.enable === '1'}
								onChange={formik.handleChange}
							/>
						...
						<label htmlFor='radio-2' className='product__form-radio m-l-8'>
							<input
								...
								type='radio'
								value='0'
								checked={formik.values.enable === '0'}
								onChange={formik.handleChange}
							/>
							<span className='product__form-radio-mark'></span>
							disable
						...
						<div className='product__form-text--error'>
							{formik.errors.enable ? formik.errors.enable : null}
						</div>
					</div>
					...
					<div className='product__form-item  flex-row'>
						<label htmlFor='other1' className='product__form-checkbox'>
							<input
								...
								type='checkbox'
								value='other1'
								checked={formik.values.other.includes('other1')}
								onChange={formik.handleChange}
							/>
						...
						<label htmlFor='other2' className='product__form-checkbox m-l-8'>
							<input
								...
								type='checkbox'
								value='other2'
								checked={formik.values.other.includes('other2')}
								onChange={formik.handleChange}
							/>
							<span className='product__form-checkbox-mark'></span>
							Other2
						...
						<label htmlFor='other3' className='product__form-checkbox  m-l-8'>
							<input
								...
								type='checkbox'
								value='other3'
								checked={formik.values.other.includes('other3')}
								onChange={formik.handleChange}
							/>
							<span className='product__form-checkbox-mark'></span>
							Other3
					...
					<div className='product__form-item'>
						...
						<div className='product__form-text--error'>
							{formik.errors.kind ? formik.errors.kind : null}
						</div>
					</div>
