			...
			<div className='product__form-form'>
				<form onSubmit={handleSubmit(onSubmit)}>
					<div className='product__form-item'>
						<input name='productName' placeholder='Product Name' type='text' {...register('productName')} className={`product__form-control ${errors.productName ? 'is-invalid' : ''}`} />
						<div className='product__form-text--error'>{errors.productName?.message}</div>
					</div>

					<div className='product__form-item'>
						<input name='price' placeholder='price' type='text' {...register('price')} className={`product__form-control ${errors.price ? 'is-invalid' : ''}`} />
					...
					<div className='product__form-item  flex-row'>
						<label htmlFor='other1' className='product__form-checkbox'>
							<input id='other1' name='other' type='checkbox' value='other1' {...register('other')} />
							<span className='product__form-checkbox-mark'></span>
							Other1
						</label>

						<label htmlFor='other2' className='product__form-checkbox m-l-8'>
							<input id='other2' name='other' type='checkbox' value='other2' {...register('other')} />
							<span className='product__form-checkbox-mark'></span>
							Other2
						</label>

						<label htmlFor='other3' className='product__form-checkbox  m-l-8'>
							<input id='other3' name='other' type='checkbox' value='other3' {...register('other')} />
							<span className='product__form-checkbox-mark'></span>
							Other3
						</label>
					</div>
					...
					<div className='product__form-item'>
						...
						<input type='file' {...register('image', { required: true })} onChange={onChangePicture} />
						<div className='product__form-text--error'>{errors.file && <p>Please select an image</p>}</div>
					</div>
					<div className='product__form-item'>
