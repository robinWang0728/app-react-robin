        ...
        <div className="product__describe">
          <div className="product__price">
            <p className="product__text product__text-price">
              <span className="product__text product__text-price--currency">
                $
              </span>
              <span className="product__text product__text-price--price">
                {price}
              </span>
            </p>
          </div>
          <div className="product__describe-btns">
            <div
              className="product__describe-btn--favor"
              onClick={() => updateFavor(props.item)}
            >
              {favor ? (
